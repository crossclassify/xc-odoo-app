try {
  console.log("API Key: ", apiKeyStored);
  console.log("Site ID: ", siteIdStored);
      ...
      window.Matomo = window.Piwik = (function () {
        ...
        function aq(aI) {
          ...
          for (ay = 0; ay < aB.length; ay += 16) {
            ...
            for (aL = 16; aL <= 79; aL++) {
              au[aL] = av(
                au[aL - 3] ^ au[aL - 8] ^ au[aL - 14] ^ au[aL - 16],
                1
              );
            }
            aH = aC;
        ...
        var w = {
          ...
          toAbsoluteUrl: function (au) {
            ...
            if (0 === au.indexOf("#")) {
              return (
                this.getLocation().origin + this.getLocation().pathname + au
              );
            }
            if (0 === au.indexOf("?")) {
              return (
          ...
          function aE(dt) {
            ...
            if (M(du.domLoading)) {
              if (du.domInteractive && du.domLoading) {
                ...
                ds +=
                  "&pf_dm1=" + Math.round(du.domInteractive - du.domLoading);
              }
            } else {
              if (du.domInteractive && du.responseEnd) {
                ...
                ds +=
                  "&pf_dm1=" + Math.round(du.domInteractive - du.responseEnd);
              }
            }
            ...
            if (du.loadEventEnd && du.loadEventStart) {
              ...
              ds +=
                "&pf_onl=" + Math.round(du.loadEventEnd - du.loadEventStart);
            }
            return dt + ds;
          }
    ...
    !(function () {
      ...
      var l = {
          ...
          hasNodeAttribute: function (t, e) {
            return t && t.hasAttribute
              ? t.hasAttribute(e)
              : !(!t || !t.attributes) &&
                  "undefined" !== typeof t.attributes[e];
          },
      ...
      function F(t) {
        ...
        this.reset(),
          ...
          this.formName ||
            (this.formName = l.getAttribute(t, "data-piwik-name")),
                ...
                (e.timeWindowBlur = null),
                  ...
                  e.firstFieldEngagementDate
                    ...
                    : ((e.timeOffWindowBeforeEngagement += t),
                      f(
                        "time off not engaged " +
                          e.timeOffWindowBeforeEngagement
                      ));
              }
            })
          ),
              ...
              ? (e(
                  ...
                  (function (t) {
                    return function (e) {
                      ...
                      (i &&
                        -1 !==
                          m.indexOfArray([9, 16, 17, 18, 20, 27, 91], i)) ||
                        e.isCtrlKey ||
                        (i >= 37 && i <= 40
                          ? t.isBlank() ||
